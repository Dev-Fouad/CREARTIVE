...
export const Hero = () => {
  return (
    <div className=' h-[900px] bg-[#E6F1FEB2] flex space-x-[61px] items-center pl-[80px] max-md:pl-[0px] max-md:flex-col max-md:space-x-0 max-md:h-[700rem] max-md:pt-[8rem] max-lg:pl-[0]'>

      <div className=' max-lg:flex max-lg:flex-col max-lg:items-center max-md:text-center'>
      ...
      {/* <div className=' w-[516px] h-[599px] relative'>

        <div className=' absolute w-[140px] bg-[#Fff] rounded-[10px] hover:shadow-lg h-[88px] px-[11px] py-[10px] top-[5rem] left-[6rem] z-50'>
        ...
        <div className=' w-[226px] h-[103px] rounded-[10px] bg-[#FFFFFF] absolute top-[22rem] right-[-6rem] p-[12px]'>
          <h2 className=' text-[10px]'>Blog</h2>
